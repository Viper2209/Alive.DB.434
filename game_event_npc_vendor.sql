...
-- Exportiere Struktur von Tabelle world3.game_event_npc_vendor
...
-- Exportiere Daten aus Tabelle world3.game_event_npc_vendor: 2 rows
...
INSERT INTO `game_event_npc_vendor` (`eventEntry`, `guid`, `slot`, `item`, `maxcount`, `incrtime`, `ExtendedCost`, `type`) VALUES
	(10, 202566, 0, 46693, 0, 0, 0, 1),
	(10, 203900, 0, 46693, 0, 0, 0, 1);
