...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
	...
	('reload arkcore_string', 3, 'Syntax: .reload trinity_string\nReload trinity_string table.'),
	...
	('lookup npc', 3, 'Syntax: .lookup npc $namepart\r\n\r\nLooks up a npc by $namepart, and returns all matches with their npc ID\'s.'),
	('opcode', 5, 'Syntax: .opcode is a developer function not intended for use only for opcode research.'),
	('reload creature_text', 3, 'Syntax: .reload creature_text\r\nReload creature_text table.'),
	('partyinfo', 2, 'Syntax: .partyinfo [$player_name]\nOutput information for members of group that include selected player or player find by $player_name.'),
	('reload all_creature_template', 3, 'Syntax: .reload all_creature_template\r\nReload the whole creature_template table\r\nWarning: This can cause lag'),
